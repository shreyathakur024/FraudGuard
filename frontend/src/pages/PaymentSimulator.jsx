...
function PaymentSimulator() {
  ...
  const handleReview = (e) => {
    ...
    setTransactionTime(now.toISOString());
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "Transaction analysis failed."
        );
      }

      /*
       * Keep the user's transaction details together
       * with the actual ML result.
       */
      const result = {
        merchant: formData.merchant.trim(),
        amount: Number(formData.amount),
      ...
      console.error("FraudGuard prediction error:", err);
      ...
      <main className="relative z-10 mx-auto max-w-6xl px-6 py-12 sm:py-16">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-slate-400">
            {step === "details"
              ? "Enter your payment details and let FraudGuard assess the transaction for potential fraud."
              : "Review your transaction details before running the FraudGuard security analysis."}
          </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs leading-5 text-slate-500">
                        The current time will be automatically
                        recorded when you review the payment.
                      </p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-6 text-slate-400">
                        Your transaction will be analyzed by
                        our machine learning fraud detection
                        service before the risk assessment is
                        displayed.
                      </p>
